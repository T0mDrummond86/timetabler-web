---
id: grid-colours
title: Placecard colours
category: The timetable grid
keywords: colours, colors, colour by class, class colour, change colour, recolour, card colour, legend
---
...
6-digit hex, like `#AABBCC`.

Manual colours belong to the class, so every placecard for that class changes
together.
