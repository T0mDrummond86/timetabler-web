---
id: warnings-room-double
title: "Room double-booking"
category: Warnings and clashes
keywords: room double booked, same room twice, two classes one room, room clash, overlapping room, room conflict
---
...
**Re-detect combined classes** on the
[Clash settings](#warnings-clash-settings) tab so they are recognised as one.
