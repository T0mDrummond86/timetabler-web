...
example *BFF7 CIII IT*.

On the **Qualifications** tab you can set:

- **Name**.
- **Number of groups** — how many cohorts it runs. Changing this creates or
  removes group courses to match.
- **Schedule period** — **Day** (08:30–19:00) or **Night** (17:30–21:30). Every
