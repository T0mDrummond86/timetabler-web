---
id: grid-zoom
title: Make the grid bigger or smaller
category: The timetable grid
keywords: zoom, bigger, smaller, too small, cannot read, scale, fit more, grid size
---
...
The zoom level is remembered per browser, so it stays as you left it.
